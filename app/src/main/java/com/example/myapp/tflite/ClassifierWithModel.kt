package com.example.myapp.tflite
...
class ClassifierWithModel(var context: Context) {
    ...
    companion object {
        //private const val MODEL_NAME = "tf_model.tflite"
        //private const val LABEL_FILE = "labels2.txt"
//        private const val MODEL_NAME = "converted_model.tflite"
//        private const val LABEL_FILE = "labels.txt"
        private const val MODEL_NAME = "flawer.tflite"
        private const val LABEL_FILE = "flawer.txt"
    }
}